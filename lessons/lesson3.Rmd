...
A) Fit a linear mixed model to answer the question of whether fillet thickness is associated with fillet hardness, with random intercepts fit to each individual fish ID. 
B) What do the model diagnostic plots tell us?
C) What does the model summary tell us?
...
[`yield ~ temperature + rainfall + temperature:rainfall + (1 | block)`]{.spoiler}
