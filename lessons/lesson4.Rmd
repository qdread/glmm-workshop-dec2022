...
We will use the `besag.beans` dataset which is part of the **agridat** package, an R package that has a bunch of classic datasets from agricultural science. You can load the dataset using 
...
1. Examine the dataset. We have genotypes being grown in 