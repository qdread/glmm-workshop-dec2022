...
We will revisit this model in the next lesson when we talk about comparing means.

# Generalized linear mixed models

Taking the log transformation of the response variable before fitting the model is a good solution for many types of data. However it won't always work. For many classes of data, **PUT MORE TEXT HERE**
...
For these next two examples, we are going to use data from the **agridat** package.
