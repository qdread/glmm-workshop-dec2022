...
- We could use `summary(fert_mm)` to get t-tests for each coefficient
- But usually more important to ask whether the means of each treatment differ from one another
...
FIXME need to finish below here
